...
namespace ProyectoFSD_WebMovies.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Sinopsis,Duracion,FechaEstreno,ImagenPelicula,GeneroId,DirectorId")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Sinopsis,Duracion,FechaEstreno,ImagenPelicula,GeneroId,DirectorId")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
